...
import {ChangeUserAddress, RemoveUserErrorOnFocus} from '../actions/users-action'

function StateSelector({error, state, ChangeUserAddress, RemoveUserErrorOnFocus}) {
...
const mapStateToProps = state => ({
    state: state.users_store.address.state,
    error: state.users_store.errors.state,
})
